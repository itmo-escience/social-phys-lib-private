...
namespace SF
{
	...
	private:
		...
		std::vector<std::pair<long long, const Obstacle*> > obstacleNeighbors_;		// list of neighbor obstacles
		std::vector<std::pair<long long, const Agent*> > agentNeighbors_;			// list of neighbor agents
